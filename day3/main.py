...
def make_line(wire):
    ...
    for instruction in wire:
        ...
        if direction == 'R':
            new_point = (prev_point[0]+steps, prev_point[1])
        elif direction == 'L':
            new_point = (prev_point[0]-steps, prev_point[1])
        elif direction == 'U':
            new_point = (prev_point[0], prev_point[1]+steps)
        elif direction == 'D':
            new_point = (prev_point[0], prev_point[1]-steps)
    
        points.append((prev_point, new_point))
...
i2 = ["D1","R50","U80","U83","L12","D49","R71","U7","L72", "U62","R66","U55","R34","D71","R55","D58","R83"]
